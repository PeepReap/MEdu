...
# Main Page
leftimage = Image.open('./assets/image_1.png').resize((640,720))
...
notwithus = tk.Button(
    text='Not with us?\nClick here',
    font=('Livvic Regular', 14, 'underline'),
    bd=0,
    fg='white',
    cursor='hand2',
    highlightthickness=0,
    background = '#220C49',
    command = lambda: webbrowser.open("https://github.com/PeepReap/MEdu/tree/Program")
)
